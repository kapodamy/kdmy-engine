...
static int script_camera_set_interpolator_type(lua_State* L) {
    ...
    AnimInterpolator type = luascript_helper_optenum(L, 2, LUASCRIPT_ENUMS_AnimInterpolator);
...
static int script_camera_set_offset(lua_State* L) {
    ...
    float x = (float)luaL_optnumber(L, 2, FLOAT_NaN);
    float y = (float)luaL_optnumber(L, 3, FLOAT_NaN);
    float z = (float)luaL_optnumber(L, 4, FLOAT_NaN);
...
static int script_camera_slide(lua_State* L) {
    ...
    float start_x = (float)luaL_optnumber(L, 2, FLOAT_NaN);
    float start_y = (float)luaL_optnumber(L, 3, FLOAT_NaN);
    float start_z = (float)luaL_optnumber(L, 4, FLOAT_NaN);
    float end_x = (float)luaL_optnumber(L, 5, FLOAT_NaN);
    float end_y = (float)luaL_optnumber(L, 6, FLOAT_NaN);
    float end_z = (float)luaL_optnumber(L, 7, FLOAT_NaN);
...
static int script_camera_slide_x(lua_State* L) {
    ...
    float start = (float)luaL_optnumber(L, 2, FLOAT_NaN);
    float end = (float)luaL_optnumber(L, 3, FLOAT_NaN);
...
static int script_camera_move_offset(lua_State* L) {
    ...
    float end_x = (float)luaL_optnumber(L, 2, FLOAT_NaN);
    float end_y = (float)luaL_optnumber(L, 3, FLOAT_NaN);
    float end_z = (float)luaL_optnumber(L, 4, FLOAT_NaN);
