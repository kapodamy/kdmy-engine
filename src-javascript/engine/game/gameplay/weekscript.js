...
function weekscript_notify_pause_optionselected(script, option_index, buttons) {
    return _weekscript_call(
        ModuleLuaScript._luascript_notify_pause_optionselected, script, option_index | 0, buttons | 0
    );
}
