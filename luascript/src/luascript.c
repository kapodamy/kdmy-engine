...
static void luascript_register_objects(lua_State* L, bool is_week) {
    ...
    const luaL_Reg_Integer GLOBALS_INTEGERS[] = {
        ...
        {"STRUM_PRESS_STATE_NONE", (int32_t)STRUM_PRESS_STATE_NONE},
        {"STRUM_PRESS_STATE_HIT", (int32_t)STRUM_PRESS_STATE_HIT},
        {"STRUM_PRESS_STATE_HIT_SUSTAIN", (int32_t)STRUM_PRESS_STATE_HIT_SUSTAIN},
        {"STRUM_PRESS_STATE_PENALTY_NOTE", (int32_t)STRUM_PRESS_STATE_PENALTY_NOTE},
        {"STRUM_PRESS_STATE_PENALTY_HIT", (int32_t)STRUM_PRESS_STATE_PENALTY_HIT},
        {"STRUM_PRESS_STATE_MISS", (int32_t)STRUM_PRESS_STATE_MISS},

        {"RANKING_NONE", (int32_t)PLAYERSTATS_RANKING_NONE},
        {"RANKING_SICK", (int32_t)PLAYERSTATS_RANKING_SICK},
        {"RANKING_GOOD", (int32_t)PLAYERSTATS_RANKING_GOOD},
        {"RANKING_BAD", (int32_t)PLAYERSTATS_RANKING_BAD},
        {"RANKING_SHIT", (int32_t)PLAYERSTATS_RANKING_SHIT},
        {"RANKING_MISS", (int32_t)PLAYERSTATS_RANKING_MISS},
        {"RANKING_PENALITY", (int32_t)PLAYERSTATS_RANKING_PENALITY},

        {"STRUM_NOTE_STATE_PENALITY", (int32_t)STRUM_SCRIPT_NOTE_PENALITY},
        {"STRUM_NOTE_STATE_MISS", (int32_t)STRUM_SCRIPT_NOTE_MISS},
        {"STRUM_NOTE_STATE_SHIT", (int32_t)STRUM_SCRIPT_NOTE_SHIT},
        {"STRUM_NOTE_STATE_BAD", (int32_t)STRUM_SCRIPT_NOTE_BAD},
        {"STRUM_NOTE_STATE_GOOD", (int32_t)STRUM_SCRIPT_NOTE_GOOD},
        {"STRUM_NOTE_STATE_SICK", (int32_t)STRUM_SCRIPT_NOTE_SICK},
