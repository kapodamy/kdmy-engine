...
EM_JS_PRFX(void, roundstats_tweenkeyframe_set_on_beat, (RoundStats roundstats, TweenKeyframe tweenkeyframe, float rollback_beats, float beat_duration), {
...
EM_JS_PRFX(void, roundstats_tweenkeyframe_set_on_hit, (RoundStats roundstats, TweenKeyframe tweenkeyframe, float rollback_beats, float beat_duration), {
...
EM_JS_PRFX(void, roundstats_tweenkeyframe_set_on_miss, (RoundStats roundstats, TweenKeyframe tweenkeyframe, float rollback_beats, float beat_duration), {
...
EM_JS_PRFX(void, roundstats_tweenkeyframe_set_bpm, (RoundStats roundstats, float beats_per_minute), {
