...
namespace Engine.Utils {
    ...
    public static partial class StringUtils {
        ...
        private static readonly int[,] STRING_LOWERCASE_TO_COMPONENTS = new int[,] {
            ...
            {0x1E9E, 0x0073, 0x0073, 0x0000, 0x0000},
        ...
        public static string ToUpperCase(string str) {
            ...
            while (StringUtils.GetCharacterCodepoint(str, index, grapheme)) {
                ...
                for (int i = 0 ; STRING_LOWERCASE_TO_COMPONENTS[i, 0] != 0x0000 ; i++) {
                    if (STRING_LOWERCASE_TO_COMPONENTS[i, 0] != grapheme.code) continue;

                    // decompose components found, unfold each one
                    for (int j = 1 ; STRING_LOWERCASE_TO_COMPONENTS[i, j] != 0x0000 ; j++) {
                        InternalDirectUppercaseConversion(STRING_LOWERCASE_TO_COMPONENTS[i, j], stringbuilder);
                    }

                    goto L_stop_searching;
                }

                // simple character unfolding
                InternalDirectUppercaseConversion(grapheme.code, stringbuilder);
            ...
            while (StringUtils.GetCharacterCodepoint(str, index, grapheme)) {
                ...
                for (int i = 0 ; STRING_UPPERCASES[i] != 0x0000 ; i++) {
                    if (STRING_UPPERCASES[i] == grapheme.code) {
                        stringbuilder.AddCharCodepointKDY(STRING_LOWERCASES[i]);
                        goto L_stop_list_checking;
                    }
                }

                // if not found, the codepoint was a number, symbol or emoji
                stringbuilder.AddCharCodepointKDY(grapheme.code);

L_stop_list_checking:
                continue;
            }
        ...
        private static void InternalDirectUppercaseConversion(int codepoint, StringBuilder stringbuilder) {
            for (int i = 0 ; STRING_LOWERCASES[i] != 0x0000 ; i++) {
