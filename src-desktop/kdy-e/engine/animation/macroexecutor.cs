...
namespace Engine.Animation {
    ...
    public class MacroExecutor : IAnimate {
        ...
        public const int MACROEXECUTOR_VERTEX_PROP_COUNT = 55;// SPRITE_PROP_* + TEXTSPRITE_PROP_* + MEDIA_PROP_* + FONT_PROP_*
        ...
        public void StateFromModifier(Modifier modifier) {
            ...
            this.state[VertexProps.SPRITE_PROP_ROTATE_PIVOT_ENABLE] = modifier.rotate_pivot_enabled == true ? 1f : 0f;
