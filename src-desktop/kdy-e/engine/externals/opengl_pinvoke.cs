...
public partial class WebGL2RenderingContext {
    ...
    internal static class NativeMethods {
        ...
        internal delegate void DglGetProgramInfoLog(GLuint program, GLsizei maxLength, out GLsizei length, nint infoLog);
        ...
        internal delegate void DglGetShaderInfoLog(GLuint shader, GLsizei maxLength, out GLsizei length, nint infoLog);
        ...
        internal delegate void DglVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, nint pointer);
        ...
        internal delegate void DglTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, nint data);
        ...
        internal delegate void DglBufferData(GLenum target, GLsizeiptr size, nint data, GLenum usage);
        ...
        internal delegate void DglDrawElementsInstanced(GLenum mode, GLsizei count, GLenum type, nint indices, GLsizei instancecount);
        ...
        internal delegate void DglGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, out GLsizei length, out GLint size, out GLenum type, nint name);
...
#pragma warning restore CS0649
        ...
        private static Delegate GetDelegateFor(Type delegateType, string functionName) {
            nint proc = wglGetProcAddress(functionName);
            ...
            nint handle = GetModuleHandle("opengl32");
            if (handle != 0x00) {
